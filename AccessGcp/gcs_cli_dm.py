...
""" ====== sma ======"""
bucket = storage_client.bucket('gcs-dm-triwin-com')

blobs = storage_client.list_blobs(bucket)

for blob in blobs:
    if blob.name.__contains__("$folder$") :
        print(blob.name)
        blob.delete()
...
#     blob_name = "app_adcost_data/install_date=" + str(day) + "_$folder$"
#     print(blob_name)
...
# """sma:  app_arpu_group"""
#
# """sma:  app_ltv_retention_day"""
# begin = 1
# end = 63
# for id in range(begin ,end):
#     blob_name = "app_ltv_retention_day/appid=" + str(id) + "_$folder$"
#     blob_name_outer = "app_ltv_retention_day/appid=" + str(id)
#     print(blob_name)
#     blob = bucket.blob(blob_name)
#     flag = blob.exists()
#     if flag is True:
...
#         print("不存在")
#     """二级分区"""
#     begin = datetime.date(2019, 9)
#     end = datetime.date(2021, 5)
#     for dt in range((end - begin).days + 1):
#         day = begin + datetime.timedelta(days=dt)
#         blob_name_inner = blob_name_outer+"/install_month=" + str(day) + "_$folder$"
...
#             print("不存在")
#
# """sma: app_ltv_retention_month/"""
# begin = datetime.date(2019, 9)
# end = datetime.date(2021, 5)
# for dt in range((end - begin).days + 1):
#     day = begin + datetime.timedelta(days=dt)
#     blob_name = "app_ltv_retention_month/login_month_date=" + str(day) + "_$folder$"
#     print(blob_name)
#     blob = bucket.blob(blob_name)
#     flag = blob.exists()
#     if flag is True:
